...
- **钥匙串或开机启动失败**：按 macOS 提示处理；开机启动注册可能需要在系统设置的登录项中批准。没有静默降低系统保护。
...
- **Keychain or launch-at-login failure**: follow macOS prompts; login-item registration may require approval in System Settings. System protections are not silently weakened.
